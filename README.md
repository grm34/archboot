...
This script perform an automatic install of ArchLinux. Pretty simple, it only ask you for hostname, username, password, which disk to use, required partitions sizes, language and if you wish or not to install a desktop environment.
